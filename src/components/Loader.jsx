...
const Loader = ({ title, subtitle, fullPage = false }) => {
  const loaderContent = (
    <div className="loader-container">
      ...
      {title && <div className="truck-page-loader-title">{title}</div>}
      {subtitle && <div className="truck-page-loader-text">{subtitle}</div>}
    </div>
  );

  if (fullPage) {
    return (
      <div className="truck-page-loader-overlay">
        {loaderContent}
      </div>
    );
  }
